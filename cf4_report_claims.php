...
$report1 = '    
    ...
    <table border="1" cellpadding="3" style="font-size: 8px; text-align: left; width: 100%;" class="table table-bordered">
        <tbody>        
            ...
            <tr>
                <td colspan="2" rowspan="2"><p style="font-weight: bold;">5. Chief Complaint</p>'.$displayResultConsultation["CHIEF_COMPLAINT"].'</td>                
            </tr>
            <tr>
                <td colspan="3"><p style="font-weight: bold;">4. Sex</p>
                <input type="checkbox" name="typeSex[]" value="M" readonly="true"'; if($displayResultEnlist["PX_SEX"] == "M"){ $report1 .= 'checked="checked"'; } $report1 .= ' />Male
                <input type="checkbox" name="typeSex[]" value="F" readonly="true"'; if($displayResultEnlist["PX_SEX"] == "F"){ $report1 .= 'checked="checked" '; } $report1 .= ' />Female
                </td>
            </tr>
            <tr>
...
$getChief = $displayResultConsultation["SIGNS_SYMPTOMS"];
...
$report1 .= '</tbody>
    ...
    <table style="width: 50%;font-style: italic;font-size: 9px;">
        <tr>
            <td>This is system generated report, signature is not required.<br/>This is not a complete Claim Form 4. <br/>Other data may look in other Claim Form.</td>
        </tr>
        <tr>
...
$pdf->Output('CF4_'.date("Ymd").'.pdf', 'I');
